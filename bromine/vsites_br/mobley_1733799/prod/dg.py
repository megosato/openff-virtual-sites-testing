...
import argparse
import pymbar
from pymbar.timeseries import statisticalInefficiency, subsampleCorrelatedData
import numpy as np
...
for p in protocols:
    ...
    try:
        ...
        timeslices = list(range(start,end,5000))
        ...
        for time in timeslices:
            ...
            for i in range(0, lambdanr):
                ...
                statinef  = statisticalInefficiency(u_nk[u_nk.columns[i]], fast=False)
            ...
            if time == timeslices[-1]:
                ...
                overlap_matrix = mbar_pymbar.computeOverlap()
