...
mpirun -np 20 mdrun_mpi -ntomp 1 -cpi prod.cpt -append -deffnm prod -replex 200 -multidir $dir/lambda_{0..19}/Production_MD
...
echo "Submitted From:     $SLURM_SUBMIT_HOST:$SLURM_SUBMIT_DIR"MBDA.cpt
echo "=================================== SLURM JOB ==================================="
echo
