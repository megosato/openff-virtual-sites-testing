...
gmx grompp -f $MDP/em.$LAMBDA.mdp -c $dir/../NPT/npt.gro -p $dir/../${topfile} -o em.tpr -maxwarn 1
...
gmx grompp -f $MDP/nvt.$LAMBDA.mdp -c ../EM/em.gro -p $dir/../${topfile} -o nvt.tpr -maxwarn 1
...
gmx grompp -f $MDP/npt.$LAMBDA.mdp -c ../NVT/nvt.gro -p $dir/../${topfile} -o npt.tpr -maxwarn 1
...
gmx grompp -f $MDP/prod.$LAMBDA.mdp -c $dir/lambda_$LAMBDA/NPT/npt.gro -p $dir/../${topfile} -o prod.tpr -maxwarn 1
